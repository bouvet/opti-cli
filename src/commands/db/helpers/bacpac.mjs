...
async function exportBacpac({ connectionString, dbName }) {
	try {
...
async function importBacpac(azuresqlContainerName) {
...
async function handleBacpacImport(containerDbName) {
	const confirmation = await confirm({
		message:
			"Do you want to import the .bacpac now? (this will delete the existing database and all its data)",
	});
